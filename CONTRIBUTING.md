# 🤝 Contributing & Submitting Homework

This guide covers how to set up your copy of the repository, submit each homework
assignment, what each submission must include, and how your work is graded.
...
Each homework folder should contain its own clear instructions in a `HOWTORUN.md`:

- 🔐 Environment setup detailed enough to run the application
- 🧪 A testing guide
